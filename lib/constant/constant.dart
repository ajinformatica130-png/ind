...
import 'package:tochegandodelivery/model/ChatVideoContainer.dart';
...
import 'package:tochegandodelivery/model/map_model.dart';
...
class Constant {
  ...
  static const globalUrl = "https://tochegandodelivery.site/";
  ...
  static Future<MapModel?> getDurationDistance(LatLng departureLatLong, LatLng destinationLatLong) async {
    ...
    http.Response restaurantTotochegandodeliveryTime = await http.get(Uri.parse('$url?units=metric&origins=${departureLatLong.latitude},'
        '${departureLatLong.longitude}&destinations=${destinationLatLong.latitude},${destinationLatLong.longitude}&key=${Constant.mapAPIKey}'));

    log(restaurantTotochegandodeliveryTime.body.toString());
    MapModel mapModel = MapModel.fromJson(jsonDecode(restaurantTotochegandodeliveryTime.body));
